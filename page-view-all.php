...
<div class="site__content">
    ...
    <div class="reviews reviews_channel">
        ...
        <dl class="filter">
            ...
            <dd>
                <?php
                $sub_categories = get_categories('parent=0');
                if (!empty($sub_categories)) {
                    foreach ($sub_categories as $sub_category) {
                        ?>
                        <a href="<?php echo get_category_link($sub_category->term_id); ?>" class="btn btn_black"><?php echo $sub_category->name; ?></a>
                        <?php
                    }
                    ?>
                <?php } ?>
