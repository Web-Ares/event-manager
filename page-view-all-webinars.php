<?php /* Template Name: View All Webinars */ ?>
    ...
    <div class="reviews reviews_channel">
        ...
        <div class="site__content-wrap">
            ...
            <div class="site__content-inner">
                ...
                <div class="site__content-forked">
                    ...
                    $all_articles_query = new WP_Query(array(
                        'paged'      => $paged,
                    ...
                    if ($all_articles_query->have_posts()) {
                        ...
                        <!-- /card-review -->
                        <?php
                        if ($all_articles_query->current_post == 0) {
                            break;
                        }
                    }
                }
            ...
            <div class="connect-with">
                ...
                <div class="connect-with__wrap">
                    ...
                    <form action="//eventmanagerblog.us11.list-manage.com/subscribe/post?u=c480f324793364ec1d982cad3&amp;id=879c173779" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate connect-with__subscribe" target="_blank" novalidate>
        ...
        <div class="pagination">
            ...
            echo paginate_links(array(
                ...
                'total'              => $all_articles_query->max_num_pages,
